...
app.config['MYSQL_DATABASE_USER'] = 'nihat'
app.config['MYSQL_DATABASE_PASSWORD'] = 'nht123'
...
# Write a function named `home` which returns 'Welcome to the Nihat's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Nihat's Bookstore API Service"
